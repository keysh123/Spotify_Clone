...
const Sidebar = () => {
  return (
    <>
    <div className='h-full w-[25%] flex-col gap-2 text-white hidden p-2 lg:flex'>
        ...
        <div className='bg-[#121212] h-[85%] rounded '>
            ...
            <div className='bg-[#242424] p-4 m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4'>
              ...
              <div className='bg-[#242424] p-4 m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
